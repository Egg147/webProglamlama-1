  ...
  <div id="topbar" class="clear"> 
    ...
    <nav>
      <ul>
        ...
        <li><a href="#">A - Z İndeks</a></li>
        <li><a href="#">Öğrenci Girişi</a></li>
        <li><a href="#">Personel Girişi</a></li>
      </ul>
    </nav>
...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">Fonksıyonlar</a></h1>
      <p>ELVIN</p>
    </div>
    <div class="fl_right">
      <form class="clear" method="post" action="#">
        <fieldset>
          ...
          <button class="fa fa-search" type="submit" title="Search"><em>ARA</em></button>
        </fieldset>
      </form>
    </div>
...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      <!-- ################################################################################################ -->
      <figure id="slide-1"><a class="view" href="#"><img src="images/demo/slider/e.png" alt=""></a>
        <figcaption>
          <h2>Uygulama-1</h2>
          <p>Fonksiyon Uygulaması</p><hr>
          <?php
           function Sa(){
              echo "Sa";
           }
           Sa();
          ?>
          <p class="right"><a href="#">Daha Fazla &raquo;</a></p>
        </figcaption>
      </figure>
      <figure id="slide-2"><a class="view" href="#"><img src="images/demo/slider/e.png"alt=""></a>
        <figcaption>
          <h2>Uygulama-2</h2>
          <p></p>
          <?php
...
function generateCreditCardTable($cardNumber, $expirationDate, $cvv)
{
    
    $table = array(
        "header" => array("Sanal Kart Numarası", "Son Kullanım Tarihi", "CVV"),
        "body" => array(
            array($cardNumber, $expirationDate, $cvv)
        )
    );
...
<table style="width: 100%; border-collapse: collapse;">
    <thead>
        <tr>
            <th style="border: 1px solid black; padding: 8px; text-align: left;">{$table["header"][0]}</th>
            <th style="border: 1px solid black; padding: 8px; text-align: left;">{$table["header"][1]}</th>
            <th style="border: 1px solid black; padding: 8px; text-align: left;">{$table["header"][2]}</th>
        </tr>
    </thead>
    <tbody>
        {$rows}
...
echo generateCreditCardTable("1111 1111 1111 0000", "09/27", "2363");
?>
          
          
        </figcaption>
      </figure>
      <figure id="slide-3"><a class="view" href="#"><img src="images/demo/slider/e.png" alt=""></a>
        <figcaption>
      ...
      <figure id="slide-4"><a class="view" href="#"><img src="images/demo/slider/e.png" alt=""></a>
        <figcaption>
          <h2>Uygulama-4</h2>
          <hr>
          <?php
      ...
      <figure id="slide-5"><a class="view" href="#"><img src="images/demo/slider/e.png" alt=""></a>
        <figcaption>
          <h2>Uygulama-5</h2>
          <p>...</p>
          <p class="right"><a href="#">Daha Fazla &raquo;</a></p>
